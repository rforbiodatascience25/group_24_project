...
<br>
Aim:
The goal of the project is to analyze which biological factors affect the patient survival rate after the transplantation
Data was taken from UC Irvine Machine Learning Repository
...
:::
<br>
The survivor group shows a slightly higher median dose in both cell types, more evident for CD3+, suggesting that higher CD34+ and especially CD3+ doses may be associated with improved survival.

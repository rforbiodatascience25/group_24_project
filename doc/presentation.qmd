...
<br>
Aim:
The goal of the project is to analyze which biological factors affect the patient survival rate after bone marrow transplant
...
:::
<br>
The survivor group shows a slightly higher median dose in both cell types, more evident for CD34+, suggesting that higher CD3+ and especially CD34+ doses may be associated with improved survival.

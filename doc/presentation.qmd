...
<br> Aim: The goal of the project is to analyze which biological factors affect the patient survival rate after bone marrow transplant
...
Conclusion - Higher CDC34+ dose and lower BMI appear to be associated with improved survival outcomes - CD3+ cell dose, HLA matching, and recovery times for neutrophils and platelets did not show a clear relationship with survival in our dataset - Further analysis for more reliable results could be proceed for future research

...
The loading plot shows a strong correlation between the CD34+ and CD3 dosage and the first principal component (PC1). Whereas recipient age and body mass are mainly correlated to PC1, but are also somewhat correlated with the second principal component (PC2).\
Platelet- and neutrophil recovery and the ratio between CD3 and CD34+ are mainly correlated with PC2.\
The variation in donor age and survival time are poorly correlated with both principal components.
...
```{r}
ggsave(here("results/plots/pca_plot.png"), width = 6, plot = pca_plot)
ggsave(here("results/plots/rotation_plot.png"), width = 6, plot = rotation_plot)
ggsave(here("results/plots/var_plot.png"), width = 6, plot = var_plot)
ggsave(here("results/plots/match_plot.png"), width = 6, plot = match_plot)
ggsave(here("results/plots/survival_plot.png"), width = 6, plot = survival_plot)
```

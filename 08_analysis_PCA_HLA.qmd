...
pca_plot
ggsave("results/pca_plot.png", width = 6 )
...
rotation_plot
ggsave("results/rotation_plot.png", width = 6 )
...
var_plot
ggsave("results/var_plot.png", width = 6 )
...
match_plot 
ggsave("results/match_plot.png", width = 6 )
...
survival_plot 
ggsave("results/survival_plot.png", width = 6 )

...
ggsave(here("results/rotation_plot.png"), width = 6, plot = rotation_plot)
ggsave(here("results/var_plot.png"), width = 6, plot = var_plot)
ggsave(here("results/match_plot.png"), width = 6, plot = match_plot)
ggsave(here("results/survival_plot.png"), width = 6, plot = survival_plot)
```

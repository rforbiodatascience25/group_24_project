---
title: "05_Analysis_Graft_vs_Host_disease"
format: html
editor: visual
---
...
: Table 1: The data used for this analysis is from `03_dat_aug` ? using these variables: `aGvHDIIIIV`, `extcGvHD`, `time_to_aGvHD_III_IV`.

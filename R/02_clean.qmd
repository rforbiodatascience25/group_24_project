...
raw_data <- read_lines(here("data/_raw/bone-marrow.arff"))
var_names <- raw_data |>
...
# Create tibble
data_clean <- read_delim(here("data/_raw/bone-marrow.arff"), 
                      delim = ",", 
...
data_clean |> write_tsv(here("data/02_dat_clean.tsv.gz"))
meta_data |> write_lines(here("data/02_metadat_clean.txt.gz"))

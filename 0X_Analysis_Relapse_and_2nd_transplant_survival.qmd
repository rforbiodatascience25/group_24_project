...
| `Diseasegroup` | Type of disease | Malignant or Nonmalignant |
...
We then generate the subset for the first part of the analysis `relapse_surv_data`.
...
First we want to look at the relationship between survival of patients and the time of observation or event. This is done by visualizing `survival_time` and `survival_status` from subset: `relapse_surv_data`.
...
Patients, who need a second transplantation INSERT STASTISTICS and still have not gone into remission (no relapse) have WRITE OUTCOME (A 50/50-ISH FOR MOW) chance of survival.

Patients with relapse have INSERT STATISTICS OF BOTH of surviving.

Patients, who does not need a second transplant have a better outcome with INSERT STASTITICS surviving.

**Outcome:** 2nd transplant seem to help some after relapse, but odds are grim in case of relapse.

*Somehow some are getting a transplant without haveing a relapse, either by getting a second transplantation before disease is fully gone... None survived having a second transplant after reoccurance of disease, only survived getting it before having relapse...*
...
See tendencies... Need something else here...

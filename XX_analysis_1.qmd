...
The time to GvGD column has been dropped as only a few number of the patients develop the disease. Thus, to ensure that the PCA analysis is basedon as many observations as possible, the variable is left out.
